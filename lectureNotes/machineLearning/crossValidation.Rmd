...
![](cvfigs/Map1NN.png){width=45%} 
![](cvfigs/Map5NN.png){width=45%} 
...
## Over-smoothing
```{r mnist-27-glm-est, echo=FALSE, fig.height = 4, fig.width = 6, out.width="90%",fig.align="center"}
...
suppressWarnings(qplot(log10(income), bins = 30, color = I("black")))
```
...
\small
```{r loess-accuracy, warning=FALSE, message=FALSE, out.width="60%",fig.align="center"}
