...
You can learn more about markdown here: https://www.markdowntutorial.com/
...
\vskip .2 in
\underline{Note:} From now on, all R-based homework will need to be turned in using an R Markdown document (uploaded to GitHub). Your document should include headers, descriptive text, R code, and  plots/figures! 
