...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item \texttt{ls -l >> directory\_contents.txt}
		\item \texttt{cat directory\_contents.txtt | head -3 | tail -2}
	...
	\begin{enumerate}
		...
		\item Set up a git repository for this extra practice on your computer (repo named ``DataScienceLectures"), add files/changes to it, and upload it to GitHub. This is how you will turn in your HW for this semester! (including this one!). 
	\end{enumerate}. 
